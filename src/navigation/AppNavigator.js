...
import KidsBabyProfileScreen from '../screens/Growth/KidsBabyProfileScreen';
...
const HomeStack = () => {
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen name="KidsBabyProfile"    component={KidsBabyProfileScreen}    options={{ headerShown: false }} />
      <Stack.Screen 
        name="Security" 
