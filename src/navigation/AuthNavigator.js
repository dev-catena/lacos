...
import RegisterChooseProfileScreen from '../screens/Auth/RegisterChooseProfileScreen';
...
const AuthNavigator = () => {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name="RegisterChooseProfile" component={RegisterChooseProfileScreen} />
