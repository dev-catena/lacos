...
## ❌ Problema
A aplicação funciona localmente em `http://192.168.100.10:8081`, mas não é acessível de outros dispositivos na rede.
...
1. **No computador (servidor)**:
   ```bash
   curl http://192.168.100.10:8081
   ```

2. **No dispositivo móvel**:
   - Abra navegador
   - Acesse: `http://192.168.100.10:8081`
