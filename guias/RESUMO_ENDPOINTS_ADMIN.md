...
### Listar usuários
```bash
curl -X GET http://192.168.100.10/api/admin/users \
...
### Bloquear usuário
```bash
curl -X POST http://192.168.100.10/api/admin/users/1/block \
  -H "Authorization: Bearer SEU_TOKEN" \
  -H "Accept: application/json"
```
...
```bash
curl -X GET http://192.168.100.10/api/admin/doctors/pending \
  -H "Authorization: Bearer SEU_TOKEN" \
  -H "Accept: application/json"
```
...
### Aprovar médico
```bash
curl -X POST http://192.168.100.10/api/admin/doctors/1/approve \
  -H "Authorization: Bearer SEU_TOKEN" \
  -H "Accept: application/json"
```
