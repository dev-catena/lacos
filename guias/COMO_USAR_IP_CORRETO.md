...
O Expo CLI está mostrando `localhost:8081` na mensagem e no QR code, mas o Metro bundler está funcionando corretamente no IP `192.168.100.10:8081`.
...
Isso vai gerar um QR code com a URL correta: `exp://192.168.100.10:8081`
...
3. Cole ou digite: `exp://192.168.100.10:8081`
...
O problema é que o Expo CLI determina o hostname antes de gerar o QR code, e está usando `localhost` mesmo com todas as variáveis de ambiente configuradas. O Metro bundler em si está funcionando corretamente e é acessível pelo IP `192.168.100.10:8081`.
