...
curl -X POST http://192.168.100.10/api/login \
...
curl -X POST "http://192.168.100.10/api/groups/${GROUP_ID}/fall-sensor/data" \
...
```bash
curl -X GET "http://192.168.100.10/api/groups/${GROUP_ID}/fall-sensor/history?limit=10" \
  -H "Authorization: Bearer ${TOKEN}"
```
...
```bash
curl -X GET "http://192.168.100.10/api/groups/${GROUP_ID}/fall-sensor/latest" \
  -H "Authorization: Bearer ${TOKEN}"
```
...
```bash
curl -X GET "http://192.168.100.10/api/groups/${GROUP_ID}/fall-sensor/alerts?hours=24" \
  -H "Authorization: Bearer ${TOKEN}"
```
