...
O app está rodando e conectado ao backend em: `http://192.168.100.10/api`
...
- Teste acessar `http://192.168.100.10/api/user` no navegador do celular
...
**Solução:**
```bash
ssh darley@192.168.100.10 "tail -50 /var/www/lacos-backend/storage/logs/laravel.log"
```
...
3. **Verifique logs do backend**:
   ```bash
   ssh darley@192.168.100.10 "tail -100 /var/www/lacos-backend/storage/logs/laravel.log"
   ```

---

**Backend:** `http://192.168.100.10/api`  
**Status:** ✅ Funcionando  
