...
A importação **DEVE ser feita no servidor** (192.168.100.10), não localmente. O banco de dados está no servidor.
...
scp scripts/DADOS_ABERTOS_MEDICAMENTOS.csv usuario@192.168.100.10:/var/www/lacos-backend/
```
