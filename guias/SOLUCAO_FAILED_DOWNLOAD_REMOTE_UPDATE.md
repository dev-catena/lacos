...
4. ✅ Substitui localhost pelo IP correto (192.168.100.10) em:
...
curl http://192.168.100.10:8081 | grep -i localhost
...
- ✅ **SEMPRE** use o IP correto: `exp://192.168.100.10:8081`
...
1. **Verificar se está na mesma rede** (LAN mode):
   ...
   # Deve estar na mesma rede que 192.168.100.10
   ```
...
3. Use a URL `exp://192.168.100.10:8081` no Expo Go
