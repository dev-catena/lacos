...
scp /home/darley/lacos/CORRIGIR_CREATE_CLIENT_REVIEW_CORRETO.sh darley@192.168.100.10:/tmp/
...
```bash
ssh darley@192.168.100.10 "sudo bash -s" < /home/darley/lacos/CORRIGIR_CREATE_CLIENT_REVIEW_CORRETO.sh
```
