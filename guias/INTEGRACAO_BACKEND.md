...
- ✅ Servidor deployado em `192.168.100.10`
...
**URL Base da API:** `http://192.168.100.10/api`
...
### Erro de Conexão
- Verifique se o servidor está rodando: `ssh darley@192.168.100.10 "sudo systemctl status nginx"`
- Verifique a URL da API em `src/config/api.js`

### Erro 500 Server Error
- Verifique os logs: `ssh darley@192.168.100.10 "tail -50 /var/www/lacos-backend/storage/logs/laravel.log"`
...
**Backend deployado e funcionando em:** `http://192.168.100.10`
