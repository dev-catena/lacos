...
- Link: `http://192.168.100.10/api/doctors/activate?token=xxx`
- Válido por 7 dias
...
```bash
curl -X POST http://192.168.100.10/api/register \
...
```bash
curl -X POST http://192.168.100.10/api/admin/doctors/{id}/approve \
...
```
http://192.168.100.10/api/doctors/activate?token=xxx
```
...
```bash
curl "http://192.168.100.10/api/doctors/activate?token=xxx"
```
