...
Quando você acessa `http://192.168.100.10:8081`, está vendo a **interface admin** ao invés do **app mobile Laços**.
...
- ✅ Inicia servidor em `http://192.168.100.10:8081`
...
- ✅ Serve a interface admin em `http://192.168.100.10:8081`

## 📋 Resumo dos Scripts

| Script | O que inicia | URL |
|--------|--------------|-----|
| `./INICIAR_APP_MOBILE_WEB.sh` | **App Mobile** (App.js) | `http://192.168.100.10:8081` |
| `./INICIAR_ADMIN_WEB.sh` | **Interface Admin** (web/) | `http://192.168.100.10:8081` |
| `./INICIAR_WEB_IP.sh` | Interface Admin (via Expo) | `http://192.168.100.10:8081` |
...
Acesse: `http://192.168.100.10:8081` → Verá o **app mobile Laços**
...
Acesse: `http://192.168.100.10:8081` → Verá a **interface admin**
