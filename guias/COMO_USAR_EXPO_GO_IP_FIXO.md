...
4. **Configura IP fixo** - Força `192.168.100.10:8081`
...
3. O app deve carregar de `exp://192.168.100.10:8081`
...
2. IP do computador é realmente `192.168.100.10`?
...
- O IP `192.168.100.10` está **hardcoded** no script
