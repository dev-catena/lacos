...
3. **Acesse:** `http://192.168.100.10:8081`

### Exemplos

- **Celular Android:** Abra Chrome, digite `http://192.168.100.10:8081`
- **iPhone:** Abra Safari, digite `http://192.168.100.10:8081`
- **Tablet:** Abra navegador, digite `http://192.168.100.10:8081`
- **Outro computador:** Abra navegador, digite `http://192.168.100.10:8081`
...
- ✅ IP deve estar correto (192.168.100.10)
...
3. **Acesse** de qualquer dispositivo: `http://192.168.100.10:8081`
