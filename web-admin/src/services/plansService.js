...
class PlansService {
  ...
  getAllFeatures() {
    return [
      ...
      { key: 'crescimento', label: 'Crescimento infantil', description: 'Registro de peso, altura e PC com gráficos OMS e calendário SBP' },
      ...
      {
        key: 'gatewayV8',
        label: 'Gateway V8 (pulseira)',
        description: 'Card na home do grupo para parear o ESP32 da pulseira, sem celular',
      },
      ...
      },
      {
        ...
        label: 'Localização (relógio)',
        description: 'Mapa com posição do relógio e últimos pontos (API Thalamus health/…/locations)',
      },
      {
        key: 'localizacaoGateway',
        label: 'Localização (gateway BLE)',
        description: 'Presença indoor por gateways MOKO: cômodo em tempo real, trajeto e vínculo pulseira↔acompanhado',
      },
    ];
  }
}
