...
# 
# ⚠️  ATENÇÃO: Este script deve ser executado NO SERVIDOR (192.168.100.10)
#    O banco de dados está no servidor, não localmente!
#
# Para executar no servidor:
#   1. Copie o CSV para o servidor: scp scripts/DADOS_ABERTOS_MEDICAMENTOS.csv usuario@192.168.100.10:/var/www/lacos-backend/
#   2. Conecte ao servidor: ssh usuario@192.168.100.10
...
echo ""
echo "📋 A importação deve acontecer no servidor (192.168.100.10)"
echo "   porque o banco de dados está lá."
echo ""
echo "📝 Para importar no servidor:"
echo ""
echo "   1. Copiar CSV para o servidor:"
echo "      scp scripts/DADOS_ABERTOS_MEDICAMENTOS.csv usuario@192.168.100.10:/var/www/lacos-backend/"
echo ""
echo "   2. Conectar ao servidor:"
echo "      ssh usuario@192.168.100.10"
echo ""
