...
# Script para executar migrations no servidor
# Corrige permissões e executa as migrations
...
echo "✅ Arquivo .env encontrado (não será modificado)"
...
echo "   3. Verifique se o usuário do banco tem permissões adequadas"
echo "   4. Teste a conexão com o banco manualmente"
    exit 1
fi
