...
echo "   3. Teste com: curl -H 'Origin: http://localhost:3000' -H 'Access-Control-Request-Method: POST' -X OPTIONS http://192.168.100.10/api/admin/login -v"
