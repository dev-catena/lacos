...
if [ $? -eq 0 ]; then
    ...
    echo "   sshpass -p \"yhvh77\" ssh -p 63022 darley@192.168.100.10 \"cd /var/www/lacos-backend && tail -30 storage/logs/laravel.log | grep -i 'uploadCertificate\|certificate'\""
else
