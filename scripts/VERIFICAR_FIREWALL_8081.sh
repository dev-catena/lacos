...
if curl -s -o /dev/null -w "%{http_code}" --connect-timeout 2 http://192.168.100.10:8081/status 2>/dev/null | grep -q "200\|404"; then
    echo "   ✅ Metro está respondendo em http://192.168.100.10:8081"
else
    echo "   ❌ Metro NÃO está respondendo em http://192.168.100.10:8081"
...
echo "   3. Verificar se o IP do PC é realmente 192.168.100.10"
