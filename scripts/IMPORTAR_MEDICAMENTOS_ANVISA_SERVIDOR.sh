...
# Este script deve ser executado NO SERVIDOR (192.168.100.10)
# 
# Uso no servidor:
...
echo "⚠️  Este script deve ser executado NO SERVIDOR (192.168.100.10)"
echo ""
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "📝 Teste a API:"
    echo "   GET http://192.168.100.10/api/medications/search?q=paracetamol"
    echo "   GET http://192.168.100.10/api/medications/stats"
else
    echo ""
