...
sshpass -p "yhvh77" scp create_popular_pharmacies_table.php darley@193.203.182.22:~/
sshpass -p "yhvh77" scp PopularPharmacy.php darley@193.203.182.22:~/
sshpass -p "yhvh77" scp PopularPharmacyController.php darley@193.203.182.22:~/
sshpass -p "yhvh77" scp api_routes_corrected.php darley@193.203.182.22:~/

# Mover arquivos no servidor
echo "📁 Movendo arquivos no servidor..."

sshpass -p "yhvh77" ssh darley@193.203.182.22 << 'SSHEOF'
