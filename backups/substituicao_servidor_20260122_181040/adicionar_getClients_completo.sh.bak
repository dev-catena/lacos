...
echo "🔧 Adicionando método getClients completo ao CaregiverController..."
echo ""
...
if grep -q "public function getClients" "$CONTROLLER_FILE"; then
    echo "⚠️ Método getClients já existe, removendo versão antiga..."
    # Encontrar e remover método antigo
...
if grep -q "public function getClients" "$CONTROLLER_FILE"; then
    echo "✅ Método getClients confirmado"
else
