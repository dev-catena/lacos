...
# Execute este script no servidor com: sudo bash RESTAURAR_ROTAS_API_COMPLETO.sh

set -e

cd /var/www/lacos-backend

echo "🔧 Restaurando rotas completas da API..."
echo ""
...
# Criar arquivo completo com todas as rotas
...
php artisan route:list | grep -E "doctors|groups|appointments" | head -10
echo ""
echo "✅ Todas as rotas foram restauradas!"
