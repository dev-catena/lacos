...
python3 test_supplier_wizard.py http://192.168.100.10/api seu_email@lacos.com sua_senha
```
...
- **Produção (HTTP):** `http://192.168.100.10/api`
- **Local (desenvolvimento):** `http://localhost/api` ou `http://192.168.100.10/api`
...
4. **Ambiente**: Certifique-se de estar testando no ambiente correto:
   ...
   - **Desenvolvimento:** `http://192.168.100.10/api`
...
**Exemplo:**
```bash
python3 test_appointment_flow.py http://192.168.100.10:8000/api 40780462319 11111111 cpf_ou_email_cuidador senha_cuidador
```

#### Usando o Script Helper
```bash
./run_appointment_test.sh http://192.168.100.10:8000/api 40780462319 11111111 cpf_ou_email_cuidador senha_cuidador
```
...
🧪 TESTE FUNCIONAL - FLUXO DE AGENDAMENTO
================================================================================
API: http://192.168.100.10:8000/api
